...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GP21_RSTN_GPIO_Port, GP21_RSTN_Pin, GPIO_PIN_SET);
  ...
  HAL_GPIO_WritePin(GPIOB, TDC_Signal_Pin|TDC_Power_Ctl_Pin|Laser_Light_Pin|TDC_Sighal_AngleReles_Pin 
                          |tlc5618_cs_Pin|wire_ctl_Pin|GP21_EN_Stop1_Pin|GP21_EN_Start_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_Init(GP21_RSTN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = GP21_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = TDC_Power_Ctl_Pin|Laser_Light_Pin|TDC_Sighal_AngleReles_Pin|tlc5618_cs_Pin 
                          |wire_ctl_Pin|GP21_EN_Stop1_Pin|GP21_EN_Start_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
